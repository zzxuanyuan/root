...
if(builtin_cloudflare)
  ...
  if(CMAKE_CXX_COMPILER_ID STREQUAL Clang)
    set(CLOUDFLARE_CFLAGS "-msse4.2 -mpclmul -O3 -Wno-format-nonliteral")
    set(CLOUDFLARE_LDFLAGS "-Qunused-arguments")
  elseif(CMAKE_CXX_COMPILER_ID STREQUAL Intel)
    set(CLOUDFLARE_CFLAGS "-msse4.2 -mpclmul -O3 -wd188 -wd181 -wd1292 -wd10006 -wd10156 -wd2259 -wd981 -wd128 -wd3179 -wd2102")
  else()
    set(CLOUDFLARE_CFLAGS "-msse4.2 -mpclmul -O3 -fPIC")
  endif()
  ExternalProject_Add(
    CLOUDFLARE
